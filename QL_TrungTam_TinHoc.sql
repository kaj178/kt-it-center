...
ALTER TABLE KhoaHoc
ALTER COLUMN MoTa NVARCHAR(1000)
...
INSERT INTO NhanVien (HoTen, GioiTinh, DiaChi, MucLuong, tk, mk, IdRole)
VALUES
	...
	INSERT INTO ADMIN (tk, mk, IdRole)
VALUES
    (N'admin', N'123', 1);



INSERT INTO HocVien (MaHocVien, HoTen, Tuoi, GioiTinh, Email, DienThoai, DiaChi)
VALUES
	...
	INSERT INTO GiangVien (MaGiangVien, HoTen, Email, DienThoai, DiaChi)
VALUES
...
VALUES
	...
	INSERT INTO KhoaHoc (MaKhoaHoc, TenKhoaHoc, MoTa)
VALUES
	...
	UPDATE KhoaHoc
SET GiaKh = 1000000, MoTa = N'Học về cú pháp và các câu lệnh SQL cơ bản.'
WHERE MaKhoaHoc = 1;

UPDATE KhoaHoc
SET GiaKh = 1500000, MoTa = N'Học về lập trình PHP và phát triển ứng dụng web.'
WHERE MaKhoaHoc = 2;

UPDATE KhoaHoc
SET GiaKh = 1200000, MoTa = N'Học về cú pháp và các khái niệm cơ bản trong ngôn ngữ Python.'
WHERE MaKhoaHoc = 3;

UPDATE KhoaHoc
SET GiaKh = 2000000, MoTa = N'Học về các phần mềm thiết kế đồ họa và kỹ năng thiết kế.'
WHERE MaKhoaHoc = 4;

UPDATE KhoaHoc
SET GiaKh = 1800000, MoTa = N'Học về các chiến lược và kỹ năng quảng cáo trực tuyến.'
WHERE MaKhoaHoc = 5;

	INSERT INTO LopHoc (MaLop, TenLop, MaPhong, MaGiangVien, MaKhoaHoc)
VALUES
    (1, N'Lớp A', 1, 1, 1),
    (2, N'Lớp B', 2, 2, 2),
    (3, N'Lớp C', 3, 3, 1),
